...
<img style="display: block;-webkit-user-select: none;margin: auto;background-color: hsl(0, 0%, 90%);transition: background-color 300ms;" src="./imagens/Placa_Arduino_Mega.jpeg" width="500" height="257">

<img style="display: block;-webkit-user-select: none;margin: auto;background-color: hsl(0, 0%, 90%);transition: background-color 300ms;" src="./imagens/Tela_TFT_Parte_Anterior.jpeg" width="500" height="376">

O jogo possui dois exercícios, um de análise sintática e outro de estudo da vírgula, divididos em níveis de dificuldade. 

<img style="display: block;-webkit-user-select: none;margin: auto;background-color: hsl(0, 0%, 90%);transition: background-color 300ms;" src="./imagens/Tela_inicial_do_jogo.jpeg" width="500" height="339">

<img style="display: block;-webkit-user-select: none;margin: auto;background-color: hsl(0, 0%, 90%);transition: background-color 300ms;" src="./imagens/Tela_de_escolha_de_atividade.jpeg" width="500" height="273">
...
<img style="display: block;-webkit-user-select: none;margin: auto;background-color: hsl(0, 0%, 90%);transition: background-color 300ms;" src="./imagens/Tela_esolha_de nivel_Analise_Sintatica.jpeg" width="500" height="279">

<img style="display: block;-webkit-user-select: none;margin: auto;background-color: hsl(0, 0%, 90%);transition: background-color 300ms;" src="./imagens/Exercicio Analise_Sintatica.jpeg" width="500" height="302">
...
<img style="display: block;-webkit-user-select: none;margin: auto;background-color: hsl(0, 0%, 90%);transition: background-color 300ms;" src="./imagens/Tela_Correto.jpeg" width="500" height="268">

<img style="display: block;-webkit-user-select: none;margin: auto;background-color: hsl(0, 0%, 90%);transition: background-color 300ms;" src="./imagens/Tela_Incorreto.PNG">
...
<img style="display: block;-webkit-user-select: none;margin: auto;background-color: hsl(0, 0%, 90%);transition: background-color 300ms;" src="./imagens/Tela_Total_de_Pontos.jpeg" width="500" height="287">
