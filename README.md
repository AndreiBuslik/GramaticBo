...
<p align="center"><img style="display: block;-webkit-user-select: none;margin: auto;background-color: hsl(0, 0%, 90%);transition: background-color 300ms;" src="./imagens/Tela_TFT_Parte_Anterior.jpeg" width="500" height="376"></p>

O jogo possui dois exercícios, um de análise sintática e outro de estudo da vírgula, divididos em níveis de dificuldade. 

<p align="center"><img style="display: block;-webkit-user-select: none;margin: auto;background-color: hsl(0, 0%, 90%);transition: background-color 300ms;" src="./imagens/Tela_inicial_do_jogo.jpeg" width="500" height="339"></p>

<p align="center"><img style="display: block;-webkit-user-select: none;margin: auto;background-color: hsl(0, 0%, 90%);transition: background-color 300ms;" src="./imagens/Tela_de_escolha_de_atividade.jpeg" width="500" height="273"></p>
...
<p align="center"><img style="display: block;-webkit-user-select: none;margin: auto;background-color: hsl(0, 0%, 90%);transition: background-color 300ms;" src="./imagens/Tela_esolha_de nivel_Analise_Sintatica.jpeg" width="500" height="279"></p>

<p align="center"><img style="display: block;-webkit-user-select: none;margin: auto;background-color: hsl(0, 0%, 90%);transition: background-color 300ms;" src="./imagens/Exercicio Analise_Sintatica.jpeg" width="500" height="302"></p>
...
<p align="center"><img style="display: block;-webkit-user-select: none;margin: auto;background-color: hsl(0, 0%, 90%);transition: background-color 300ms;" src="./imagens/Tela_escolha_de_nivel_Virgulas.jpeg" width="500" height="364"></p>

<p align="center"><img style="display: block;-webkit-user-select: none;margin: auto;background-color: hsl(0, 0%, 90%);transition: background-color 300ms;" src="./imagens/Exercicio_Virgula.jpeg" width="500" height="297"></p>
...
<p align="center"><img style="display: block;-webkit-user-select: none;margin: auto;background-color: hsl(0, 0%, 90%);transition: background-color 300ms;" src="./imagens/Tela_Correto.jpeg" width="500" height="268"></p>

<p align="center"><img style="display: block;-webkit-user-select: none;margin: auto;background-color: hsl(0, 0%, 90%);transition: background-color 300ms;" src="./imagens/Tela_Incorreto.PNG"></p>
...
<p align="center"><img style="display: block;-webkit-user-select: none;margin: auto;background-color: hsl(0, 0%, 90%);transition: background-color 300ms;" src="./imagens/Tela_Total_de_Pontos.jpeg" width="500" height="287"></p>
